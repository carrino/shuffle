...
export const EXACT_TV_40: readonly number[] = [1.000000, 1.000000, 1.000000, 0.990859, 0.768758, 0.444000, 0.223042, 0.115259, 0.058205, 0.029175, 0.014597, 0.007300, 0.003650, 0.001825, 0.000912, 0.000456]; // m=1..16
...
export type AnchoredDeckSize = 40 | 52 | 60 | 100;

function tvTable(n: AnchoredDeckSize): readonly number[] {
  return n === 40 ? EXACT_TV_40 : n === 52 ? EXACT_TV_52 : n === 60 ? EXACT_TV_60 : EXACT_TV_100;
}
...
export const M_KNEE_40 = mShufflesFor(40, EPS_KNEE); // 6
export const M_FAIR_40 = mShufflesFor(40, EPS_FAIR); // 10
export const M_STRICT_40 = mShufflesFor(40, EPS_STRICT); // 12
...
export function theoryMilestones(n: AnchoredDeckSize): { knee: number; fair: number; strict: number } {
  if (n === 40) return { knee: M_KNEE_40, fair: M_FAIR_40, strict: M_STRICT_40 };
